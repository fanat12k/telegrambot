...
public class TelegramConstant {
  ...
  public static final String SUCCESS_RESPONSE_MASSAGE = ":white_check_mark: :white_check_mark: :white_check_mark: Status : 200 :white_check_mark: :white_check_mark: :white_check_mark:";
  public static final String ERROR_RESPONSE_MASSAGE = ":skull_crossbones: :skull_crossbones: :skull_crossbones: Server Die %s :skull_crossbones: :skull_crossbones: :skull_crossbones:";
  ...
  public static final String ERROR = ":x: :x: :x: Critical error :x: :x: :x:";
  ...
  public static final String CHECK_URL = "https://fotel.com.ua/group/rx/rozprodazh-tovariv-dlya-domu/quantity";
